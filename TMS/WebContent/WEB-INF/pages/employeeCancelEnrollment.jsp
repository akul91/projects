...
<h2><b>Select the enrollment which you want to cancel:-</b></h2>
<table>
	<tr>
		<td><c:choose>
			<c:when test="${fn:length(trainingList) > 0}">
				<form:form  action="eCancelEnrolTraining1.htm" commandName="employee" >
...
<center><br/><button type="submit" class="sexybutton sexylarge"><span><span><span class="cancel">Cancel</span></span></span></button></center>	
</form:form>
</c:when>
<c:otherwise>
